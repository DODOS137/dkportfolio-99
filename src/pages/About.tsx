      ...
      <main className="pt-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto mt-40">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="backdrop-blur-sm p-6 border border-black/10 bg-transparent rounded-md mt-16">
