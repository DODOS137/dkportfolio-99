          ...
          <div className="rounded-lg p-8 md:p-12 py-[50px] bg-transparent px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                <h3 className="text-xl font-light text-white mb-4">Brand Analysis</h3>
                <div className="flex-1 flex items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Heritage Study & Identity Research</p>
                </div>
              </div>
              ...
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Wayfinding System</p>
                  <p className="text-gray-400 text-sm leading-relaxed">Visitor Experience</p>
                </div>
              </div>
              ...
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Brand Integration</p>
                  <p className="text-gray-400 text-sm leading-relaxed">Modern Design Principles</p>
                </div>
              </div>
            </div>
          </div>
