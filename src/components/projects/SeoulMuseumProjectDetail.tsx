...
/* ============================
   ...
   ============================ */
const LiteYouTube: React.FC<{
  id: string;
  title?: string;
  className?: string;
}> = ({ id, title = "YouTube video", className = "" }) => {
          ...
          <div className="relative">
              ...
              <div className="sticky top-32 w-[170px]">
                <div className="border border-white/10 bg-black/70 backdrop-blur-sm p-3 text-xs text-gray-400 leading-relaxed">
                  ...
                  <p className="text-gray-400 mb-4">
                    Spatial & Exhibition Designer Designer
                  </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-6 mt-6 md:mt-6">
                    ...
                    <p className="text-base md:text-base lg:text-base leading-relaxed font-light text-gray-400">
                      Renew the museum’s outdated spatial and exhibition
                      language while working within the existing architectural
                      framework, and propose a distinctly Korean concept not
                      previously introduced to the institution.
                    </p>
                  </div>
                    ...
                    <div className="px-4 pb-4 pt-6 space-y-4">
                      <div>
                        <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                          1. Propose a new, distinctly Korean concept not
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
                  ...
                  <div className="space-y-6">
                    <div className="mb-6 mt-6 md:mt-6">
                      ...
                      <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                        An outdated museum identity and fragmented visitor
                        experience weakened the museum’s cultural relevance.
                      </p>
                    </div>
                    ...
                    <div className="mb-6 mt-6 md:mt-6">
                      ...
                      <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                        Transform the museum into a contemporary cultural
                        landmark by integrating architectural renewal, immersive
                        interiors, VR extension, and brand storytelling.
                      </p>
                    </div>
                    ...
                    <div className="mb-6 mt-6 md:mt-6">
                      ...
                      <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                        Façade renewal concept, spatial renders, VR museum,
                        exhibition graphics, identity system, merchandise, and
                        visitor-experience design assets.
                      </p>
                    </div>
                    ...
                    <details className="mt-4 mb-6 rounded-lg border border-white/10 bg-black">
                      ...
                      <div className="px-4 pb-4 pt-6 space-y-4">
                        <div>
                          <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                            1. Research identified demand for a renewed museum
                            experience with clearer Korean identity, stronger
                            spatial engagement, and contemporary visual
                            language.
                          </p>
                        </div>
                        <div>
                          <p className="text-sm md:text-sm leading-relaxed font-light text-gray-400">
                            2. A survey was conducted with 213 individuals who
                            had previously visited the Seodaemun Museum of
                            Natural History, either on-site or online. Among
                            them, 32 participants had also experienced renowned
                            natural history museums abroad. While the museum's
                            collection of specimens was largely appreciated, 84%
                            of respondents (179 people) highlighted the need for
                            spatial and interior renewal. Critical feedback
                            pointed to the building's outdated grey façade and
                            lack of distinctive identity, often being compared
                            to a generic municipal office rather than a museum.
                            In addition, 72% (153 people) felt that the
                            exhibitions relied too heavily on static text and
                            specimens, lacking engaging storytelling or
                            interactive interpretation. 67% (142 people)
                            expressed disappointment at the absence of digital
                            media or interactive technologies such as AR and VR.
                            59% (126 people) noted insufficient accessibility
                            and inclusivity, citing limited multilingual support
                            and lack of tactile features for disabled visitors.
                            Importantly, 64% (137 people) highlighted the
                            absence of a uniquely Korean perspective, observing
                            that the museum resembled a generic international
                            format rather than reflecting local cultural
                            identity. Finally, 71% (151 people) emphasized the
                            need for stronger community and educational
                            engagement, pointing out the lack of workshops,
                            public programs, and collaborations with schools.
                            The findings reveal a strong demand not only for
                            architectural redefinition but also for narrative,
                            technological, and cultural transformation that
                            aligns with contemporary expectations for cultural
                            institutions.
                          </p>
                        </div>
                      </div>
            ...
            <div className="max-w-[1540px] mx-auto px-4 md:px-[250px]">
              ...
              <div className="my-0 md:my-0 relative">
                ...
                <div className="mb-4 grid grid-cols-[auto_1fr] gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="mt-4 mb-4 text-sm md:text-sm text-gray-400 leading-relaxed font-light">
                      Immersive sound-led exhibition amplifying overlooked
                      marine life. Reframes ocean conservation through emotional
                ...
                <AspectRatio
                  ratio={16 / 9}
                  className="rounded-lg border border-[#F7931E] overflow-hidden"
                >
                  <LiteYouTube
                    id="8GEK3igRom0"
                    title="Project video"
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    The reception area presents the museum’s renewed identity
                    through a three-storey vertical installation inspired by
                    Korean folding screens and mountain landscapes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    The exhibition is divided into a Marine Zone on the first
                    floor and a Terrestrial Zone on the upper levels. A vertical
                    sculptural void connects the floors, linking immersive
                    media, natural specimens, and historical artefacts into one
                    continuous ecological journey.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    A hunter’s study-inspired rest area displays personal
                    collections, insects, and expedition artefacts. It creates a
                    quiet observation point overlooking the vertical glass
                    sculpture connecting all three floors.
                  </p>
                </div>
              </div>
              ...
              <div className="my-0 md:my-0 relative ">
                <div className="relative z-10">
                  <p className="font-Medium mb-4">
                    ...
                    <span className="ml-4 text-base md:text-base text-white">
                      Ocean Awareness Gap + Hybrid Exhibition{" "}
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400 mb-3">
                    In late Joseon Korea, hunters viewed nature not merely as a
                    means of survival, but as a realm of spiritual reverence.
                    Animals were tracked with care and honoured as living
                    beings, with tigers often referred to as San-gun, or
                    “Mountain Lord.” This respect also extended to falconry,
                    where Maekkun formed mutual relationships with wild hawks
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400 mb-3">
                    Rooted in this worldview, Through the Eyes of a Hunter
                    reimagines the Seodaemun Museum of Natural History as a
                    culturally grounded space. The project transforms static
                    displays into an interpretive journey shaped by Korean
                    perspectives on nature, coexistence, and memory.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-10 items-start">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm md:text-sm font-light text-gray-400 leading-relaxed font-light mb-3">
                    서울특별시 서대문구 연희로 32길 51 (연희동 서대문자연사
                    박물관){" "}
                  </p>

                  <p className="text-sm md:text-sm font-light text-gray-400 leading-relaxed font-light ">
                    51, Yeonhui-ro, 32-gil, Seodaemun-gu. Seoul, Republic of
                    Korea
                  </p>
                </div>
              </div>
              ...
              <div className="mb-3 flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    As visitors move from the Marine Hall to the upper
                    Terrestrial Halls, the spatial textures gradually shift from
                    smooth to coarse, reflecting how sea, river, and mountain
                    environments shape stone differently. This erosion gradient
                    becomes a visual language across the museum’s sculptural
                    elements and built-in furniture, linking each ecological
                    zone to a distinct material atmosphere.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    Visitors encounter a sequence of built-in wall cabinets,
                    each dedicated to a specific theme—from preserved biological
                    specimens to rare books and historical artifacts—creating
                    layered moments of discovery throughout the exhibition.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-transparent">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                  <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                    ...
                    <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                      The gift shop concept features products inspired by native
                      Korean species, reinforcing the museum’s identity. Items
                      include collectible cards of endangered animals and
                      resin-encased specimens of Korean insects.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:space-x-16">
                <div className="rounded-lg bg-transparent flex flex-col md:flex-row md:items-start md:space-x-16">
                  ...
                  <p className="text-sm md:text-sm lg:text-sm font-light text-gray-400">
                    Delivered a complete, testable museum experience
                    encompassing space, identity, product, and narrative logic.
                    With the support of Seodaemun Museum of Natural History, a
                    seven-day solo exhibition was conducted within the museum,
                    incorporating feedback from both visitors and staff.
                    Structured for ongoing refinement, the work anticipates
                    future feedback loops through public interaction and
                    prototyping.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full mb-20 md:mb-40">
                <img
                  src="/webimages/SNM/SNM20.jpg"
                  className="w-full h-auto mb-40 md:mb-0"
                  loading="lazy"
                  decoding="async"
                  fetchPriority="low"
                />
