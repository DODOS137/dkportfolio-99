  ...
  const processSteps = [
    {
      ...
      items: ["Stakeholder Consultation"]
    },
    {
      title: "Design Development",
      items: ["Modular Design", "Sustainable Materials"]
    },
    {
      title: "Implementation",
      items: ["Adaptive Spaces", "Community Integration"]
    }
  ];
  ...
  return (
    <ProjectLayout>
      ...
      <section className="pb-20">
        ...
        <div className="max-w-[1540px] mx-auto mb-32 px-6 relative z-0 md:px-[150px]">
