...
const InvisibleProjectDetail = () => {
  ...
  return <div className="min-h-screen bg-black text-white">
      ...
      <section className="pb-20">
        ...
        <div className="absolute max-w-[1540px] mx-auto mb-32 px-6 relative z-10 md:px-0">
        ...
        <div className="max-w-[1540px] mx-auto mb-32 px-6 relative z-10 md:px-[150px]"data-lovable-editable="false">
          <div className="rounded-lg p-8 md:p-12 py-[50px] bg-transparent px-0">
            ...
            <div className="max-w-[1540px] mx-auto mb-32 relative z-10 md:px-150 px-0"data-lovable-editable="true">
