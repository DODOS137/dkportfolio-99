        ...
        <div className="max-w-[1540px] mx-auto px-6 md:px-[200px] z-10 relative -mt-[0%]">
          ...
          <div className="mb-32">
            <div className="rounded-lg py-[50px] bg-transparent">
              ...
              {/* 5th image */}
              <div className="w-full mb-8">
                <img alt="Planet A233 - VR Environment" className="w-full h-auto" data-lovable-editable="true" src="/lovable-uploads/abb8e78a-e337-4bb9-8629-e28e0c698ed8.png" />
                    </div> 
              {/* 6th image */}
              <div className="w-full mb-8">
                <img alt="Planet A233 - VR Environment" className="w-full h-auto" data-lovable-editable="true" src="/lovable-uploads/25653fdb-24b1-4d42-9473-28b6cbc1e1d5.png" />
                    </div> 
