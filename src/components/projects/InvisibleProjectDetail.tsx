        ...
        <div className="max-w-[1540px] mx-auto px-6 md:px-[200px] z-10 relative -mt-[0%]">
          ...
          <div className="mb-32">
            <div className="rounded-lg py-[50px] bg-transparent">
              ...
              <p data-lovable-editable="true" className="text-lg md:text-xl text-gray-400 leading-relaxed mb-8">{project.approach}</p>
              <h2 className="text-2xl md:text-3xl font-light mb-8 text-white" data-lovable-editable="true">Development Strategy</h2>
              <p data-lovable-editable="true" className="text-lg md:text-xl text-gray-400 leading-relaxed">{project.development}</p>
            </div>
          </div>
          ...
          <div className="mb-32">
            <div className="rounded-lg py-[50px] bg-transparent">
              ...
              <div className="rounded-lg bg-transparent pt-[50px]">
                ...
                <p data-lovable-editable="true" className="text-lg md:text-xl text-gray-400 leading-relaxed mb-8">
