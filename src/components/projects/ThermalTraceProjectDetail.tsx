    ...
    <ScrollArea className="h-screen w-screen overflow-auto">
      <ProjectLayout>
        ...
        <ProjectHero
          ...
          subtitle="Reimagining the Fashion Show Through XR"
          year="2022-2025"
        ...
        <section>
          {/* Hero follow-up image (container with side paddings) */}
          ...
          {/* Full-bleed color plate + image (keeps full bleed intentionally) */}
          <div className="my-40 md:my-40 relative">
            ...
            {/* foreground content */}
            <div className="max-w-[1540px] mx-auto px-4 md:px-[250px] relative z-10">
              <AspectRatio ratio={16 / 9} className="bg-[#FF7F00] border-none overflow-hidden rounded-lg">
          ...
          {/* Separator (full-bleed line kept) */}
          ...
          <div className="max-w-[1540px] mx-auto px-4 md:px-[250px]">
            <div className="rounded-lg bg-transparent border border-gray-500 overflow-hidden">
              <InteractiveImageSection
          ...
          {/* Navigation (centered; container not necessary but safe) */}
          <div className="max-w-[1540px] mx-auto px-4 md:px-[250px]">
