          ...
          <div className="rounded-lg p-8 md:p-12 py-[50px] bg-transparent px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                <h3 className="text-xl font-light text-white mb-4">Concept Development</h3>
                <div className="flex-1 flex items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Thermal Data Analysis</p>
                </div>
              </div>
              
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                <h3 className="text-xl font-light text-white mb-4">AR Integration</h3>
                <div className="flex-1 flex flex-col items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Physical-Digital Mapping</p>
                  <p className="text-gray-400 text-sm leading-relaxed">Real-time Visualization</p>
                </div>
              </div>
              
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center border border-white">
                <h3 className="text-xl font-light text-white mb-4">Exhibition Design</h3>
                <div className="flex-1 flex flex-col items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">Interactive Installation</p>
                  <p className="text-gray-400 text-sm leading-relaxed">User Experience</p>
                </div>
              </div>
            </div>
          </div>
