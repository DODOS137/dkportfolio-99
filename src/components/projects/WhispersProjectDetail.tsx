        ...
        <div className="max-w-[1540px] mx-auto  px-[250px] z-10 ">        
          ...
          <div className="rounded-lg bg-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col">
                <h3 className="text-white text-lg mb-4 text-center">3D Model</h3>
                <div className="flex-1 flex items-center justify-center">
                  <ModelViewer 
                    modelUrl="/path/to/whispers-model.glb"
                    className="w-full h-full"
                  />
                </div>
              </div>
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col">
                <h3 className="text-white text-lg mb-4 text-center">Interactive Display</h3>
                <div className="flex-1 flex items-center justify-center">
                  <ModelViewer 
                    modelUrl="/path/to/interactive-display.glb"
                    className="w-full h-full"
                  />
                </div>
              </div>
              <div className="aspect-square bg-black rounded-lg p-8 flex flex-col text-center">
                <h3 className="text-white text-lg mb-4">Process</h3>
                <div className="flex-1 flex flex-col items-center justify-center">
                  <p className="text-gray-400 text-sm leading-relaxed">{project.development}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Video Section */}
          <div className="rounded-lg bg-transparent mb-20">
            <h2 className="text-2xl font-light mb-12 md:text-xl text-gray-300">Exhibition Experience</h2>
            <div className="w-full">
