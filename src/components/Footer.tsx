...
const Footer = () => {
  return <footer className="bg-black text-white border-t border-black mt-auto py-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-4 pb-4 mt-8 flex flex-col sm:flex-row justify-between items-center">
